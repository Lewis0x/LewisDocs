...
- **FreeCAD 是开源参数化 CAD 讨论中最常被引用的平台之一**：2002 年由 Jürgen Riegel 创立<sup><a href="https://en.wikipedia.org/wiki/FreeCAD" target="_blank" rel="noreferrer">[百科 1]</a></sup>，**2024 年 11 月 18 日发布 1.0 版本**——经过 **22 年开发**才达到 1.0 稳定版<sup><a href="https://wiki.freecad.org/Release_notes_1.0" target="_blank" rel="noreferrer">[官方 2]</a><a href="https://hackaday.com/2024/11/20/freecad-version-1-0-released/" target="_blank" rel="noreferrer">[新闻 3]</a></sup>。LGPL 2.1+ 授权，跨 Windows/Linux/macOS 三平台。
- **App/Gui 严格 MVC 分离是 FreeCAD 架构的核心**<sup><a href="https://deepwiki.com/FreeCAD/FreeCAD" target="_blank" rel="noreferrer">[第三方 4]</a>[官方 5]</sup>：App 层（业务逻辑）完全不依赖 Gui 层（Qt/Coin3D），通过 boost::signals2 实现单向观察者模式。这意味着 FreeCAD 可在**无显示器、无 Qt 的服务器**上运行 headless 模式——是开源 CAD 中少见的"工业级架构"。
- **基于 OCCT（Open CASCADE Technology）几何内核**<sup><a href="https://en.wikipedia.org/wiki/FreeCAD" target="_blank" rel="noreferrer">[百科 1]</a><a href="https://dev.opencascade.org/project/freecad" target="_blank" rel="noreferrer">[官方 6]</a></sup>：OCCT 是少数开源工业级 B-Rep 内核之一，前身是 1990s Matra Datavision 的 EUCLID-IS 内核，1999 年开源。这是 FreeCAD 能够提供"真正参数化 CAD"（而非 polygonal）的根本原因。
- **Python 是一等公民**：FreeCAD 把 Python 集成到极致<sup>[官方 7]</sup>——所有 C++ 对象有 `getPyObject()` 暴露为 Python，所有 Python 对象可保存 C++ 指针，**FeaturePython 类**让纯 Python 对象作为 DocumentObject 参与文档生命周期。Python 不是脚本附加，而是平台基底。
- **Workbench 体系**：FreeCAD 的功能按"工作台"组织——Sketcher、Part、PartDesign、Draft、Arch（建筑）、Path（CAM）、TechDraw（图纸）、FEM（有限元）、Assembly（装配，1.0 集成）等<sup>[官方 8]</sup>。每个 Workbench 是独立 Python/C++ 模块，可由 Addon Manager 动态安装。
- **Topological Naming Problem (TNP) 修复**是 1.0 的关键里程碑<sup><a href="https://wiki.freecad.org/Release_notes_1.0" target="_blank" rel="noreferrer">[官方 2]</a><a href="https://hackaday.com/2024/11/20/freecad-version-1-0-released/" target="_blank" rel="noreferrer">[新闻 3]</a><a href="https://www.ondsel.com/blog/toponaming-problem-is-history/" target="_blank" rel="noreferrer">[第三方 9]</a></sup>：TNP 是参数化 CAD 的根本性挑战——上游特征修改后下游引用面/边的"内部 ID"变化导致下游特征断裂。**FreeCAD 1.0 集成了 RealThunder（社区开发者）的 LinkStage 3 fork 修复方案**，由 Ondsel 公司协助合并到上游。这是开源 CAD 几年来最重要的工程突破。
- **Ondsel 故事**：商业公司 Ondsel 基于 FreeCAD 提供商业服务（Ondsel ES），是 TNP 修复的重要推动者。⚠️ **2024 年底 Ondsel 关闭**<sup><a href="https://www.webpronews.com/freecad-1-1-arrives-the-open-source-cad-challenger-that-commercial-software-vendors-can-no-longer-ignore/" target="_blank" rel="noreferrer">[新闻 10]</a></sup>，但开发者继续贡献到 FreeCAD upstream——这是开源治理弹性的标志性事件。
- **FreeCAD 1.1（2026 年 3 月报道）**<sup><a href="https://www.webpronews.com/freecad-1-1-arrives-the-open-source-cad-challenger-that-commercial-software-vendors-can-no-longer-ignore/" target="_blank" rel="noreferrer">[新闻 10]</a></sup>：进一步扩展 TNP 修复到 Sketcher 和 PartDesign，改进 Assembly Workbench，支持 STEP AP242。
- **下载量与社会化**：GitHub 累计下载约 **2000 万次**（2025-12）<sup><a href="https://en.wikipedia.org/wiki/FreeCAD" target="_blank" rel="noreferrer">[百科 1]</a></sup>。Linus Torvalds 是 FreeCAD 用户，2025 年 9 月在 KiCon Europe 演示用 FreeCAD 设计吉他踏板外壳<sup><a href="https://en.wikipedia.org/wiki/FreeCAD" target="_blank" rel="noreferrer">[百科 1]</a></sup>。

---

## Key Findings

1. **创立时间**：2002 年由德国程序员 Jürgen Riegel 启动<sup><a href="https://en.wikipedia.org/wiki/FreeCAD" target="_blank" rel="noreferrer">[百科 1]</a></sup>，最初目标是 KEDA / DAIMLER 内部使用的开源 CAD。
2. **License**：LGPL 2.1+<sup><a href="https://en.wikipedia.org/wiki/FreeCAD" target="_blank" rel="noreferrer">[百科 1]</a></sup>。⚠️ 之前曾因 OCCT 与 LibreDWG 的 GPL 兼容性问题受限，2014 年起 OCCT 改为 LGPL，FreeCAD 成为完全 GPL-free 的工具。
3. **核心库依赖**<sup><a href="https://en.wikipedia.org/wiki/FreeCAD" target="_blank" rel="noreferrer">[百科 1]</a><a href="https://dev.opencascade.org/project/freecad" target="_blank" rel="noreferrer">[官方 6]</a></sup>：
   - **OCCT (Open CASCADE Technology)**：B-Rep 几何内核
   - **Coin3D**：3D 显示引擎（Open Inventor 的开源实现）
   - **Qt**：GUI 框架
   - **Python**：嵌入式脚本与扩展
   - **Boost**：底层 C++ 工具（含 boost::signals2 用于 App/Gui 解耦）
4. **FreeCAD 1.0 发布**：**2024-11-18**<sup><a href="https://wiki.freecad.org/Release_notes_1.0" target="_blank" rel="noreferrer">[官方 2]</a><a href="https://hackaday.com/2024/11/20/freecad-version-1-0-released/" target="_blank" rel="noreferrer">[新闻 3]</a></sup>，22 年开发后首个稳定版。
5. **FreeCAD 1.1 发布**：2025-2026 年间，扩展 TNP 修复 + STEP AP242<sup><a href="https://www.webpronews.com/freecad-1-1-arrives-the-open-source-cad-challenger-that-commercial-software-vendors-can-no-longer-ignore/" target="_blank" rel="noreferrer">[新闻 10]</a></sup>。
6. **架构分层**<sup><a href="https://deepwiki.com/FreeCAD/FreeCAD" target="_blank" rel="noreferrer">[第三方 4]</a></sup>：5 层 - Foundation Libraries → Core App (App) → GUI Framework (Gui) → 3D Visualization (Coin3D) → Workbenches。
7. **App/Gui 单向依赖**：通过 boost::signals2 实现观察者模式，App 不知道 Gui 存在<sup><a href="https://deepwiki.com/FreeCAD/FreeCAD" target="_blank" rel="noreferrer">[第三方 4]</a></sup>。
8. **FeaturePython 扩展类**：让纯 Python 类作为 DocumentObject 参与<sup><a href="https://deepwiki.com/FreeCAD/FreeCAD" target="_blank" rel="noreferrer">[第三方 4]</a></sup>——这是 FreeCAD Workbench 开发的核心抽象。
9. **.FCStd 文件格式**<sup><a href="https://en.wikipedia.org/wiki/FreeCAD" target="_blank" rel="noreferrer">[百科 1]</a><a href="https://deepwiki.com/FreeCAD/FreeCAD" target="_blank" rel="noreferrer">[第三方 4]</a></sup>：ZIP 包，内含：
   - `Document.xml`：所有 App 对象的几何/参数定义
   - `GuiDocument.xml`：Gui 视觉表现（颜色、可见性等）
   - `*.brep`：每个对象的 OCCT B-Rep 二进制
   - 缩略图
10. **TNP 修复方案**：基于 RealThunder（社区开发者）的 LinkStage 3 fork，**bgbsww**（社区贡献者）担任主架构师。⚠️ **bgbsww 在 1.0 发布前数周去世**，1.0 献给他<sup><a href="https://wiki.freecad.org/Release_notes_1.0" target="_blank" rel="noreferrer">[官方 2]</a></sup>。
11. **Workbench 数量**：核心约 15 个内置 + Addon Manager 中数百个第三方<sup>[官方 8]</sup>。
12. **OCCT 8 适配**：OCCT 8.0 计划 2026 年 2 月发布，FreeCAD 已开始适配<sup><a href="https://github.com/FreeCAD/FreeCAD/issues/25496" target="_blank" rel="noreferrer">[第三方 11]</a></sup>。
...
FreeCAD 由 Jürgen Riegel 在 2002 年启动<sup><a href="https://en.wikipedia.org/wiki/FreeCAD" target="_blank" rel="noreferrer">[百科 1]</a></sup>，最初目标是为德国汽车制造业（DaimlerChrysler 内部）提供一个轻量级的开源 CAD/PLM 工具。次年 Werner Mayer 加入，至今仍是核心维护者之一。
...
- **2007**：0.7 引入 Sketcher
- **2010**：0.11 引入 PartDesign
- **2014**：0.14 完全去 GPL（OCCT 转为 LGPL）<sup><a href="https://en.wikipedia.org/wiki/FreeCAD" target="_blank" rel="noreferrer">[百科 1]</a></sup>
- **2018**：0.17 重大更新，引入 Path/CAM Workbench
- **2020**：0.19 开始 TNP 修复探索<sup>[第三方 12]</sup>
- **2022**：0.20 大量 UI 改进
- **2023**：0.21 进一步改进
- **2024-11-18**：**1.0** 发布<sup><a href="https://wiki.freecad.org/Release_notes_1.0" target="_blank" rel="noreferrer">[官方 2]</a></sup>
...
TNP 是参数化 CAD 的根本性挑战<sup><a href="https://github.com/FreeCAD/FreeCAD-documentation/blob/main/wiki/Topological_naming_problem.md" target="_blank" rel="noreferrer">[官方 13]</a></sup>：

> "The topological naming issue is a complex problem in CAD modelling that stems from the way the internal FreeCAD routines handle updates of the geometrical shapes created with the OCCT kernel. This problem is not unique to FreeCAD. It is generally present in CAD software, but most other CAD software has heuristics to reduce the impact of the problem on users."<sup><a href="https://github.com/FreeCAD/FreeCAD-documentation/blob/main/wiki/Topological_naming_problem.md" target="_blank" rel="noreferrer">[官方 13]</a></sup>

**问题的本质**：参数化模型由前后依赖的特征序列构成。当用户回到早期特征修改尺寸或几何后，重新计算时**面/边的内部 ID 可能改变**，导致下游特征引用错误对象，模型断裂。

**RealThunder 的解决方案**：
- 社区开发者 RealThunder 在自己的 fork（LinkStage 3）中开发了 TNP 修复算法<sup><a href="https://www.ondsel.com/blog/toponaming-problem-is-history/" target="_blank" rel="noreferrer">[第三方 9]</a></sup>
...
- **bgbsww**（社区开发者）担任主架构师
- 2024 年 5 月 Ondsel 在 weekly builds 中默认启用 TNP 修复<sup><a href="https://www.ondsel.com/blog/toponaming-problem-is-history/" target="_blank" rel="noreferrer">[第三方 9]</a></sup>
- 2024-11-18 FreeCAD 1.0 正式发布，含完整 TNP 修复<sup><a href="https://wiki.freecad.org/Release_notes_1.0" target="_blank" rel="noreferrer">[官方 2]</a></sup>

⚠️ **bgbsww 的纪念**：FreeCAD 1.0 发布前数周，主 TNP 架构师 bgbsww 去世<sup><a href="https://wiki.freecad.org/Release_notes_1.0" target="_blank" rel="noreferrer">[官方 2]</a></sup>。1.0 release notes 明确："This release is dedicated to him."<sup><a href="https://wiki.freecad.org/Release_notes_1.0" target="_blank" rel="noreferrer">[官方 2]</a></sup>
...
Ondsel 是 2022 年成立的初创公司，基于 FreeCAD 提供商业服务（Ondsel ES, Ondsel Lens 等）。Ondsel 在 2024 年底关闭<sup><a href="https://www.webpronews.com/freecad-1-1-arrives-the-open-source-cad-challenger-that-commercial-software-vendors-can-no-longer-ignore/" target="_blank" rel="noreferrer">[新闻 10]</a></sup>：

> "Ondsel, a startup that had been building commercial services around FreeCAD, shut down in late 2024, but several of its developers continued contributing to the core project. The community absorbed that talent rather than losing it — a sign of organizational resilience."<sup><a href="https://www.webpronews.com/freecad-1-1-arrives-the-open-source-cad-challenger-that-commercial-software-vendors-can-no-longer-ignore/" target="_blank" rel="noreferrer">[新闻 10]</a></sup>
...
FreeCAD 1.1（2026 年 3 月已有报道）<sup><a href="https://www.webpronews.com/freecad-1-1-arrives-the-open-source-cad-challenger-that-commercial-software-vendors-can-no-longer-ignore/" target="_blank" rel="noreferrer">[新闻 10]</a></sup>的关键改进：
...
**OCCT 8 适配**：OCCT 8.0 计划 2026 年 2 月发布，FreeCAD 团队已开始适配工作<sup><a href="https://github.com/FreeCAD/FreeCAD/issues/25496" target="_blank" rel="noreferrer">[第三方 11]</a></sup>。

### 1.6 用户基础与社会化

GitHub 累计下载约 **2000 万次**（2025-12 数据）<sup><a href="https://en.wikipedia.org/wiki/FreeCAD" target="_blank" rel="noreferrer">[百科 1]</a></sup>。Google Trends 显示 FreeCAD 搜索量在 2020-2025 年间增长 200%<sup><a href="https://en.wikipedia.org/wiki/FreeCAD" target="_blank" rel="noreferrer">[百科 1]</a></sup>。

**有趣的高知名度用户**：Linus Torvalds（Linux 创始人）2025 年 9 月在 KiCon Europe 上展示了用 FreeCAD 设计的吉他踏板 PCB 外壳<sup><a href="https://en.wikipedia.org/wiki/FreeCAD" target="_blank" rel="noreferrer">[百科 1]</a></sup>。
...
FreeCAD Project Association (FPA) 是 2021 年成立的非营利组织<sup><a href="https://www.webpronews.com/freecad-1-1-arrives-the-open-source-cad-challenger-that-commercial-software-vendors-can-no-longer-ignore/" target="_blank" rel="noreferrer">[新闻 10]</a></sup>，负责<sup><a href="https://www.webpronews.com/freecad-1-1-arrives-the-open-source-cad-challenger-that-commercial-software-vendors-can-no-longer-ignore/" target="_blank" rel="noreferrer">[新闻 10]</a></sup>：
- 接收捐赠
- 协调开发优先级
- 雇佣全职贡献者
- 与企业赞助商对接
...
DeepWiki 对 FreeCAD 架构的精确描述<sup><a href="https://deepwiki.com/FreeCAD/FreeCAD" target="_blank" rel="noreferrer">[第三方 4]</a></sup>：

> "FreeCAD implements a strict Model-View-Controller (MVC) pattern through complete separation of application logic (App) and user interface (Gui). This design enables headless operation, automated testing, and clean API boundaries."<sup><a href="https://deepwiki.com/FreeCAD/FreeCAD" target="_blank" rel="noreferrer">[第三方 4]</a></sup>

> "The App layer is completely independent of GUI code and can run without Qt or graphics libraries. The Gui layer observes the App layer through boost::signals2 connections, ensuring unidirectional dependency flow."<sup><a href="https://deepwiki.com/FreeCAD/FreeCAD" target="_blank" rel="noreferrer">[第三方 4]</a></sup>
...
App 层通过 boost::signals2 暴露事件信号，Gui 层在创建时连接这些信号<sup><a href="https://deepwiki.com/FreeCAD/FreeCAD" target="_blank" rel="noreferrer">[第三方 4]</a><a href="https://deepwiki.com/FreeCAD/FreeCAD/1.2-gui-framework-and-tree-view-system" target="_blank" rel="noreferrer">[第三方 14]</a></sup>：
...
每个 App::DocumentObject 在 GUI 模式下有对应的 Gui::ViewProvider<sup><a href="https://deepwiki.com/FreeCAD/FreeCAD" target="_blank" rel="noreferrer">[第三方 4]</a></sup>：
...
FreeCAD 把 Python 集成到 CAD 业界少见的深度<sup><a href="https://deepwiki.com/FreeCAD/FreeCAD" target="_blank" rel="noreferrer">[第三方 4]</a>[官方 7]</sup>：
...
⭐ **FeaturePython 是 FreeCAD 扩展机制的核心**<sup><a href="https://deepwiki.com/FreeCAD/FreeCAD" target="_blank" rel="noreferrer">[第三方 4]</a>[官方 7]</sup>。它让纯 Python 类作为 DocumentObject 参与文档生命周期：
...
FreeCAD 的 Property System 是 strongly-typed 的<sup><a href="https://deepwiki.com/FreeCAD/FreeCAD" target="_blank" rel="noreferrer">[第三方 4]</a></sup>：
...
每个 Workbench 是一个 Python/C++ 模块<sup><a href="https://deepwiki.com/FreeCAD/FreeCAD/1.2-gui-framework-and-tree-view-system" target="_blank" rel="noreferrer">[第三方 14]</a></sup>：
...
参数化 CAD 的根本困境<sup><a href="https://github.com/FreeCAD/FreeCAD-documentation/blob/main/wiki/Topological_naming_problem.md" target="_blank" rel="noreferrer">[官方 13]</a><a href="https://www.ondsel.com/blog/toponaming-problem-is-history/" target="_blank" rel="noreferrer">[第三方 9]</a></sup>：
...
⚠️ **这是参数化 CAD 业界的普遍问题**，不是 FreeCAD 独有<sup><a href="https://github.com/FreeCAD/FreeCAD-documentation/blob/main/wiki/Topological_naming_problem.md" target="_blank" rel="noreferrer">[官方 13]</a></sup>：
...
RealThunder 的解决方案核心思想<sup><a href="https://www.ondsel.com/blog/toponaming-problem-is-history/" target="_blank" rel="noreferrer">[第三方 9]</a><a href="https://github.com/FreeCAD/FreeCAD-documentation/blob/main/wiki/Topological_naming_problem.md" target="_blank" rel="noreferrer">[官方 13]</a></sup>：
...
RealThunder 的 LinkStage 3 fork 已经多年验证可行，但合并到 upstream 面临挑战<sup><a href="https://www.ondsel.com/blog/toponaming-problem-is-history/" target="_blank" rel="noreferrer">[第三方 9]</a></sup>：
...
Ondsel 在 2023-2024 年组织 task force，bgbsww 担任主架构师，把 LinkStage 3 的核心算法逐步重写、规范化、加测试，合并到 upstream<sup><a href="https://www.ondsel.com/blog/toponaming-problem-is-history/" target="_blank" rel="noreferrer">[第三方 9]</a></sup>。

### 5.4 1.0 的成果与 1.1 的扩展

⚠️ **1.0 的 TNP 修复不是 100% 完美**<sup><a href="https://github.com/FreeCAD/FreeCAD/issues/17041" target="_blank" rel="noreferrer">[第三方 15]</a></sup>：
- 1.0 RC2 仍发现部分 TNP 边角案例（GitHub Issue #17041）
- 修复主要覆盖 PartDesign，其他 Workbench（如 Sketcher）覆盖度较低

**1.1 的扩展**<sup><a href="https://www.webpronews.com/freecad-1-1-arrives-the-open-source-cad-challenger-that-commercial-software-vendors-can-no-longer-ignore/" target="_blank" rel="noreferrer">[新闻 10]</a></sup>：
- 进一步覆盖 Sketcher
- 更广泛的 PartDesign 场景
- 自动修复机制（用户编辑时智能猜测并提示）
...
FreeCAD 文档中的对象通过 Property（特别是 PropertyLink、PropertyLinkSub）形成依赖图<sup><a href="https://deepwiki.com/FreeCAD/FreeCAD" target="_blank" rel="noreferrer">[第三方 4]</a></sup>：
...
`.FCStd` 是 ZIP 文件，内含<sup><a href="https://en.wikipedia.org/wiki/FreeCAD" target="_blank" rel="noreferrer">[百科 1]</a><a href="https://deepwiki.com/FreeCAD/FreeCAD" target="_blank" rel="noreferrer">[第三方 4]</a></sup>：
...
`Document.xml` 是声明式 XML，包含所有 App 对象的 Property 序列化<sup><a href="https://deepwiki.com/FreeCAD/FreeCAD" target="_blank" rel="noreferrer">[第三方 4]</a></sup>：
...
OCCT（Open CASCADE Technology）是少数开源工业级 B-Rep 几何内核之一<sup><a href="https://dev.opencascade.org/project/freecad" target="_blank" rel="noreferrer">[官方 6]</a></sup>：
...
FreeCAD 几乎所有几何能力都基于 OCCT<sup><a href="https://en.wikipedia.org/wiki/FreeCAD" target="_blank" rel="noreferrer">[百科 1]</a><a href="https://dev.opencascade.org/project/freecad" target="_blank" rel="noreferrer">[官方 6]</a></sup>：
...
⚠️ FreeCAD 需要紧跟 OCCT 版本演进<sup><a href="https://github.com/FreeCAD/FreeCAD/issues/25496" target="_blank" rel="noreferrer">[第三方 11]</a></sup>：
...
FreeCAD 在样本平台中是 MVC 实践较彻底的代表。这种设计让 headless 模式、自动化测试、批处理成为天然能力——而样本中部分商业 CAD 这些能力多数是"事后追加"。
...
- **DWG 支持依赖 ODA File Converter**：FreeCAD 自身不能读写 DWG，需要外部 ODA File Converter 转换<sup><a href="https://en.wikipedia.org/wiki/FreeCAD" target="_blank" rel="noreferrer">[百科 1]</a></sup>。
...
- **Linus Torvalds KiCon 演讲**：2025-09-12 演讲，由 Aleksander Sadowski 与 Linus 在 Linus Tech Tips YouTube 频道展示<sup><a href="https://en.wikipedia.org/wiki/FreeCAD" target="_blank" rel="noreferrer">[百科 1]</a></sup>。
