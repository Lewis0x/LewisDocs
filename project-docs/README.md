...
| [03-开发文档](./03-development.md) | 开发 / 内容维护者 / 运维 | **§0 金规则：本地优先**；修改源文档、调整站点、Cloudflare 面板配置、水印取证；**§12 主题层踩坑录** —— 改 CSS / Vue 组件前必看 |
| [04-使用文档](./04-usage.md) | 阅读者 / 团队成员 | 第一次访问站点 |
| [05-注释方法学](./05-annotation-methodology.md) | 写新内容的作者 / 审 PR 的维护者 | 何时给术语加注释、用哪种通道（T1-T4 决策树） |
| [06-引用核实](./06-citation-audit.md) | 维护者 | 8 篇厂商文档 704 引用核实结果 + 待修清单 + 重跑工具（3.9 BricsCAD 待纳入下一轮）|
