...
AutoCAD R13（1995）首次引入 ObjectARX<sup><a href="https://en.wikipedia.org/wiki/ObjectARX" target="_blank" rel="noreferrer">[百科 1]</a></sup>——基于 C++ 的运行时扩展架构，替代 ADS 成为底层 SDK。从此开始 AutoCAD 平台具备"in-process 原生 C++ 扩展"能力，奠定了 30 年来的 API 哲学基础。
