...
DWG 文件格式封闭性是 Autodesk 的核心战略资产<sup><a href="https://en.wikipedia.org/wiki/Open_Design_Alliance" target="_blank" rel="noreferrer">[百科 5]</a></sup>。即便 [ODA](/glossary#oda-open-design-alliance)（Open Design Alliance）提供了 Drawings SDK 反向工程读写 DWG，Autodesk 仍持续主导格式演进，让兼容厂商始终落后一个版本周期。
